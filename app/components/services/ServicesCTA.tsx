        ...
        <section className="py-20 px-6 md:px-12">
            <div className="max-w-5xl mx-auto text-center rounded-3xl border border-yellow-500/20 bg-gradient-to-r from-yellow-500/10 via-white/5 to-yellow-500/10 p-10 md:p-16">
                ...
                <div className="flex flex-wrap justify-center gap-4">
                    <button className="bg-yellow-400 text-black px-6 py-3 rounded-full font-medium hover:scale-105 transition duration-300 inline-flex items-center gap-2" onClick={() => openContactModal("book-consultation")}>
