...
export default function ServiceBlock({
    ...
    return (
        <div className="space-y-6 rounded-3xl border border-white/10 p-8 md:p-10 bg-gradient-to-b from-white/5 to-transparent">
            ...
            <div className="flex flex-wrap gap-4 pt-2">
                {points.map((item, i) => (
                    <div
                        key={i}
                        className="group px-6 py-4 border border-white/20 rounded-xl text-sm md:text-base text-[#F1DC7F]
