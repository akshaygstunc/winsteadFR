      ...
      <div className="px-6 md:px-12 lg:px-20 py-8 border-b border-white/10">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
            ...
            <a className="px-6 py-3 rounded-full border border-white/20 hover:border-[#F1DC7F] hover:text-[#F1DC7F] transition" href={`https://wa.me/+970000000?text=Hey I am intersted in your services`}
              target="_blank"
