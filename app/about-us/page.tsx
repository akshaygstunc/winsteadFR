...
export default function AboutUs() {
  ...
  const bannerImage = aboutPage?.data?.bannerImage;
  const helpItems = [
              ...
              <div className="w-full max-w-7xl  px-6 md:px-12 pb-14 md:pb-20">
                <div className="max-w-xl text-left">
                  ...
                  <p className="mb-3 text-[11px] uppercase tracking-[0.35em] text-[#F1DC7F]">
                    {aboutPage?.bannerTitle || "About Us"}
                  </p>
      
                  {/* SUBTITLE (API split for styling) */}
                  <h1 className="text-xl md:text-2xl xl:text-5xl font-semibold leading-[1.05] max-w-[520px]">
                    {aboutPage?.bannerSubtitle?.split("\n")[0] || "Luxury real estate"}
              ...
              <div>
                <div className="relative w-full h-[150px] md:h-[300px] mb-20">
                  {loading ? (
                    ...
                    <img
                      src={
                        aboutPage?.data?.aboutWinsteadImage ||
                        aboutPage?.data?.image
                      }
                      alt="About"
