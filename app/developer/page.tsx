...
function SkeletonCard() {
  return <div className="animate-pulse rounded-[28px] bg-white/5 h-[400px]" />;
}
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="mb-14 md:mb-16 flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8">
          ...
          <p className="text-white text-sm md:text-lg max-w-xl leading-relaxed">
            Explore globally trusted real estate developers known for
            exceptional architecture, premium communities, and high-value
            investment portfolios curated for luxury living.
          </p>
        </div>
            ...
            : filteredDevelopers.map((developer) => (
                ...
                >
                  <article className="rounded-3xl border border-[#D4AF37]/20 bg-gradient-to-b from-white/[0.04] to-white/[0.02] backdrop-blur-xl hover:border-[#FFD700]/50 hover:shadow-[0_0_30px_rgba(255,215,0,0.12)] transition-all duration-300 p-6 flex items-center gap-5">
                    {/* Logo */}
                    <div className="relative w-20 h-20 min-w-[64px] rounded-2xl overflow-hidden bg-gradient-to-br from-gray-100 to-gray-400 flex items-center justify-center border border-gray-200">
                      <Image
                        src={developer.image}
                        alt={developer.name}
                        fill
          ...
          <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
            <div className="max-w-2xl">
              ...
              <p className="mt-4 text-white/60 text-base md:text-lg leading-relaxed">
                ...
                the best builder portfolio for residential, commercial, or
