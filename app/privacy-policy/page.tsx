...
export default function LegalPage() {
  ...
  const [pageDetails, setPageDetails] = useState<LegalPageApiResponse | null>(
    null,
  );
  ...
  useEffect(() => {
    async function fetchPage() {
      try {
        ...
        const response =
          await WebsiteContentService.getSingletonBySlug("privacy-policy");
  ...
  const page = useMemo(() => {
    ...
    const title =
      pageDetails.title || pageDetails.data?.bannerTitle || EMPTY_TEXT;
    const description = pageDetails.description || EMPTY_TEXT;
    const heroImage = pageDetails.image || pageDetails.data?.bannerImage || "";
    const metaTitle =
      pageDetails.metaTitle || pageDetails.data?.metaTitle || "";
    const metaDescription =
      pageDetails.metaDescription || pageDetails.data?.metaDescription || "";
    ...
    return {
      ...
      bannerSecondaryButtonText:
        pageDetails.data?.bannerSecondaryButtonText || "",
      bannerSecondaryButtonUrl:
        pageDetails.data?.bannerSecondaryButtonUrl || "",
